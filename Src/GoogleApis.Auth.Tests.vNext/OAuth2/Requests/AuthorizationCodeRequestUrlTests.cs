...
namespace Google.Apis.Auth.OAuth2.Requests
{
    ...
    public class AuthorizationCodeRequestUrlTests
    {
        ...
        public void TestConstructor()
        {
            ...
            Assert.Equal(request.AuthorizationServerUrl, Is.EqualTo(AuthorizationCodeUrl));
        ...
        public void TestBuild_DefaultValues()
        {
            ...
            Assert.Equal(uri, Is.EqualTo(new Uri(AuthorizationCodeUrl.ToString() + "?response_type=code")));
        }
        ...
        public void TestBuild()
        {
            ...
            var uri = request.Build();
            Assert.Equal(uri, Is.EqualTo(new Uri(AuthorizationCodeUrl.ToString() +
