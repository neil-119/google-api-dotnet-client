...
namespace Google.Apis.Tests.Apis.Requests
{
    ...
    public class ParameterCollectionTest
    {
        ...
        {
            var testCreate = new ParameterCollection();
        }
        ...
        public void MultipleAddTest()
        {
            ...
            // 1. Empty case.
            Assert.Equal(col.Count, Is.EqualTo(0));
            Assert.Equal(new string[0], col.GetAllMatches("test"));

            // 2. One element.
            col.Add("black", "hole");
            Assert.Equal(col.Count, Is.EqualTo(1));
            Assert.Equal(new[] { "hole" }, col.GetAllMatches("black"));

            // 3. Another element.
            col.Add("white", "dwarf");
            Assert.Equal(col.Count, Is.EqualTo(2));
            Assert.Equal(new[] { "hole" }, col.GetAllMatches("black"));
        ...
        public void DuplicateTest()
        {
            ...
            Assert.Equal(col.Count, Is.EqualTo(3));
        ...
        public void FromQueryStringTest()
        {
            ...
            Assert.Equal(collection.Count, Is.EqualTo(4));
        ...
        public void FromDictionaryTest()
        {
            ...
            Assert.Equal(collection.Count, Is.EqualTo(8));
        }
    }
}
