...
namespace Google.Apis.Tests.Apis.Requests
{
    ...
    class RequestBuilderTest
    {
        ...
        public void TestBasicWebRequest()
        {
            ...
            Assert.Equal(request.RequestUri, Is.EqualTo(new Uri("http://www.example.com/")));
        }
        ...
        public void TestBasePlusPathMath()
        {
            ...
            var request = builder.CreateRequest();
            Assert.Equal(request.Method, Is.EqualTo(HttpMethod.Put));
            Assert.Equal(request.RequestUri, Is.EqualTo(new Uri("http://www.example.com/test/path")));
        }
        ...
        public void TestSingleQueryParameter()
        {
            ...
            var request = builder.CreateRequest();
            Assert.Equal(request.RequestUri, Is.EqualTo(new Uri("http://www.example.com/?testQueryParam=testValue")));
        }
        ...
        public void TestMultipleQueryParameter()
        {
            ...
            var request = builder.CreateRequest();
            Assert.Equal(request.RequestUri, Is.EqualTo(
        ...
        public void TestMultipleQueryParameters()
        {
            ...
            var request = builder.CreateRequest();
            Assert.Equal(request.RequestUri, Is.EqualTo(new Uri("http://www.example.com/?q=value1&q=value2")));
        }
        ...
        public void TestNullQueryParameters()
        {
            ...
            Assert.Equal(builder.BuildUri().AbsoluteUri, Is.EqualTo("http://www.example.com/?p"));
        }
        ...
        public void TestPathParameter()
        {
            ...
            var request = builder.CreateRequest();
            Assert.Equal(request.RequestUri, Is.EqualTo(new Uri("http://www.example.com/test/value/foo/bar")));
        }
        ...
        public void TestPathParameterWithUrlEncode()
        {
            ...
            var request = builder.CreateRequest();
            Assert.Equal(request.RequestUri, Is.EqualTo(new Uri("http://www.example.com/test/%20%25va%2Fue")));
        }
        ...
        public void TestQueryAndPathParameters()
        {
            ...
            Assert.Equal(builder.BuildUri().AbsoluteUri, Is.EqualTo("http://www.test.com/colors?list=red,yellow&on=1"));
        }
        ...
        private void SubtestPathParameters(IDictionary<string, IEnumerable<string>> dic, string path, string expected)
        {
            ...
            Assert.Equal(builder.BuildUri().AbsoluteUri, Is.EqualTo("http://www.example.com/" + expected));
        }
    }
}
